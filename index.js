...
// src/prompts/add/index.ts
var add = () => (0, import_prompts.default)(steps).then(console.log);
...
var templatesAsSelectOptions2 = TEMPLATES.flatMap((f) => f.variants).map(templateAsSelectOption);
var steps2 = [
  {
    type: "text",
    name: "targetDir",
  ...
  },
  {
    ...
    message: reset("Select a template:"),
    initial: 0,
    choices: templatesAsSelectOptions2
  }
];
...
function start() {
  return (0, import_prompts3.default)(steps3).then((result) => result.command);
}
var options2 = [
  {
